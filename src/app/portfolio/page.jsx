   ...
   return (
      <motion.div className="h-full" initial={{y:"-200vh"}} animate={{y:"0%"}} transition={{duration:1}}>
         <div className="h-[600vh] relative">
            <div className="w-screen h-[calc(100vh-6rem)] flex items-center justify-center text-8xl text-center text-indigo-950">My Works</div>

            <div className=" sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
               <motion.div style={{ x:x}} className=" flex">
                  <div className=" h-screen w-screen flex items-center justify-center bg-gradient-to-r from-red-200 to-red-200"/>
                  {Items.map((item) => (
                     <div className={` h-screen w-screen flex items-center justify-center bg-gradient-to-r ${item.color}`} key={item.id}>
                        ...
                        <div className=" flex flex-col gap-8 md:gap-4 text-white ">
                           ...
                           <div className="w-80 md:w-96 lg:w-[500px] lg:text-lg xl:-[600px]">
                              ...
                              <button className="p-2 md:w-[6vw] text-sm md:p-2  md:text-md lg:text-lg bg-white text-gray-600 font-semiboldm-4 rounded-md">Visit</button>
                              </Link>
                           </div>
                  ...
                  <div className=" h-screen w-screen flex items-center justify-center bg-gradient-to-r from-blue-300 to-white"/>
                  <div className=" h-screen w-screen flex items-center justify-center bg-gradient-to-r from-white to-white"/>
               </motion.div>
         ...
         <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
            <h1 className=" text-8xl text-indigo-950">Do you have a project?</h1>
            <div className="relative">
               <motion.svg animate={{rotate:360}} transition={{duration:8, ease:"linear", repeat:Infinity}} viewBox="0 0 300 300" className="w-64 h-64 md:w-[500px] md:h-[500px]">
                  ...
                  <text fill="#000">
                     <textPath xlinkHref="#circlePath" className="text-xl text-indigo-950">
                       Back-end and Front-end Developer
                     </textPath>
                  </text>
               </motion.svg>
               <Link href='/contact' className="w-16 h-16 md:w-28 md:h-28 absolute top-0 left-0 right-0 bottom-0 m-auto bg-indigo-950 text-white rounded-full flex items-center justify-center">
