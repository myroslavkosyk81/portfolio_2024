   ...
   return (
      <AnimatePresence mode="wait">
         <div key={pathName} className="w-screen h-screen bg-gradient-to-b from-blue-200 to-red-200">
            <motion.div  className="h-screen w-screen fixed bg-indigo-950 rounded-b-[100px] z-40"
            animate={{height: '0vh'}}
            exit={{height: "140vh"}}
            ...
            <motion.div  className="h-screen w-screen fixed bg-indigo-950 rounded-t-[100px] bottom-0 z-30"
